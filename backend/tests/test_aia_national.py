...
class TestNationalOfficials:
    def test_parse_arbitro_and_assistenti(self):
        roles = dict(_parse_national_officials("PERRI VOTTA – PRESSATO IV: MASSA VAR: DI BELLO AVAR: SERRA"))
...
class TestParseDettaglio:
    def test_parses_two_matches(self):
        ...
        hub = NationalHub("can", "https://www.aia-figc.it/designazioni/can/", "dettaglio", "aia-figc-can", "C.A.N.")
